...
//print_r($pro_name); die("ssadas");
    ...
    if(!empty($error)){
        ...
        header("Location:../dash/add-product.php");
    }
...
//echo "<pre>"; print_r($db); die;
    if(isset($id) && !empty($id)){
        ...
        $sql = " UPDATE tbl_product SET pro_title = '".$pro_title."', pro_description  = '".$subject."', seller_name = '".$name."', seller_num  = '".$seller_num."', pro_category_id = '".$category."', pro_price  = '".$pro_price."', pro_name = '".$pro_name."' WHERE pro_id  = $id ";
    } else {
        $sql = " INSERT INTO tbl_product (pro_title,pro_description,seller_name,seller_num,pro_category_id,pro_price,pro_name) VALUES ('" . $pro_title . "','" . $subject . "','" . $name . "','" . $seller_num . "','" . $category . "','" . $pro_price . "','" . $pro_name . "')";
    }
